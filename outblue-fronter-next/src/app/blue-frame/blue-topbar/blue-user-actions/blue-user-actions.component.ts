...
const MENU_BUTTONS: MenuButton[] = [
  ...
  { type: 'main', icon: 'envelope', title: LanguageLabel.MENU_MESSAGING, action: {component: MessagingComponent},
  alt: { icon: 'mail-bulk', title: LanguageLabel.MENU_MESSAGING_EXTENDED}, tag: Tag.MESSAGING },
  { type: 'line' },
  { type: 'main', icon: 'language', title: LanguageLabel.MENU_LANGUAGE, action: {component: LanguageComponent, width: '30%', height: '40%'} },
  { type: 'main', icon: 'palette', title: LanguageLabel.MENU_PREFERENCES, action: {component: PreferenceComponent} },
  ...
  openWindow(button: MenuButton): void {
    ...
    this.dialog.open(button.action.component, {
      ...
      data: {
        ...
        title: button.alt ? button.alt.title : button.title
      }
    });
  }
